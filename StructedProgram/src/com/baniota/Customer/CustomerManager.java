...
public class CustomerManager {
        ...
        while (true) {
            ...
            switch (menu.charAt(0)) {
                case 'i':
                    ...
                    break;
                case 'p':
                	printPreCustomerData();
                    break;
                case 'n':
                	printNextCustomerData();
                    break;
                case 'c':
                	printNowCustomerData();
                    break;
                case 'u':
                	updateCustomerData();
                    break;
    ...
    // 고객데이터 출력
    public static void printPreCustomerData() {
         ...
         if (index < 0) {
             ...
             System.out.println("이름 : " + customer.getNameList());
    ...
    public static void printNowCustomerData() {
